...
<html>
    ...
    <body class="centertable" onload="refreshPage('matrizes', 'resposta_matrizes_dinamicas.jsp?op=<%=op%>&dima=<%=dima%>&dimb=<%=dimb%>&dimc=<%=dima%>&dimd=<%=dimb%>');">
        ...
        Linhas de A <input type="text" name="dima" readonly="true" value="<%=dima%>" id="dima"  />
        Colunas de A e Linhas de B <input type="text" value="<%=dimb%>" readonly="true"   name="dimb" id="dimb" />
        Colunas de B <input type="text" name="dimc" value="2" id="dimc" onkeyup="refreshPage('matrizes', 'resposta_matrizes_dinamicas.jsp?op=<%=op%>&dima='+getElementById('dima').value+'&dimb='+getElementById('dimb').value+'&dimc='+getElementById('dimb').value+'&dimd='+getElementById('dimc').value)" />
        <div id="matrizes" ></div>
